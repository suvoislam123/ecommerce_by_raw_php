<?php
include_once($_SERVER['DOCUMENT_ROOT']."/ecommerce/src/crud/Product.php");
use crud\Product;
$product_obj = new Product();
$pdo = $product_obj->connect();
$all_product_query = "SELECT * FROM products";
$all_product = $product_obj->read($pdo,$all_product_query);
// echo "<pre>";
// print_r($all_product);
// echo "</pre>";

//This portion is for debuggin
?>
                    ...
                    <div class="products">
                      <div class="product">
                        ...
                        <div class="product-info text-left">
                          ...
                          <div class="product-price"> <span class="price"> $<?=$product['unit_price'] ?> </span> <span class="price-before-discount">$ 800</span> </div>
                          <!-- /.product-price --> 
